...
@Slf4j
public class CAT001ParseTestMain {
    ...
    public static String parseStr(String kafkaMsgStr) {
        ...
        CAT001KafkaMsgNew cat001KafkaMsg = new CAT001KafkaMsgNew(data);

        String value = cat001KafkaMsg.getData().getData().getValue();
...
//        }
        try {
            CAT001Data cat048Data = new CAT001Data(ints, 0, cat001KafkaMsg.getDataLength());
...
//        300016fe16652a340848497ed469032b018ce04606bc
        String s2= "010016fe16652a340848497ed469032b018ce04606bc";
